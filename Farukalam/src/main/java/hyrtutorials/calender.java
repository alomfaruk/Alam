...
public class calender {
	...
	public void fourthdate() throws InterruptedException {
		javascriptutilities.jsclick(driver,fourthdatefield);
		Thread.sleep(1000);
		javascriptutilities.draW_bordergreen(driver,fourthdatefield);
		Thread.sleep(1000);
		javascriptutilities.flashing(fourthdatefield, driver);
	}
	public void thirddateall() throws InterruptedException {
		...
		javascriptutilities.selectdatejs(driver, day3, thirddatefield);
	...
	public void seconddate() throws InterruptedException {
		...
		javascriptutilities.selectdatejs(driver, day2, seconddatefield);
		Thread.sleep(1000);
		javascriptutilities.draW_border(driver, seconddatefield);
	}
	public void firstdate() throws InterruptedException {
		javascriptutilities.draW_bordergreen(driver, firstdatefield);
		Thread.sleep(1000);
		firstdatefield.click();
		Thread.sleep(1000);
		String day1="10/12/2002";
		javascriptutilities.selectdatejs(driver, day1, firstdatefield);
		javascriptutilities.draW_border(driver, firstdatefield);
